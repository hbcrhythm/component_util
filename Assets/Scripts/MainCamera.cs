...
//{
    ...
    public class MainCamera : MonoBehaviour
    {
        ...
        void GroundTest1()
        {
            ...
            {
                Physics.Raycast(new Ray(p2, transform.up), out _hit, _cameraHeight * .5f, LayerMask.GetMask("Ground"));
                p3 = p2 + transform.up * _cameraHeight * .5f; //近平面上的边缘点
            }
            ...
            // 相机前移
            Vector3 newPos = p1 + transform.forward * Vector3.Distance(p3, p4);
            transform.position = new Vector3(newPos.x, Mathf.Max(newPos.y, height), newPos.z);
            ...
            // 相机前移
            //transform.position = p1 + transform.forward * Vector3.Distance(p3, p4);
            Vector3 newPos2 = p1 + transform.forward * Vector3.Distance(p3, p4);
            transform.position = new Vector3(newPos2.x, Mathf.Max(newPos2.y, height), newPos2.z);
            //TODO: 修复边缘穿模
